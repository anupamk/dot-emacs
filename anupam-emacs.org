...
#+begin_src emacs-lisp :tangle "anupam-emacs-module/anupam-emacs-utilities.el"
  ...
  (use-package wucuo
    ...
    ;; major-mode basis.
    (setq wucuo-personal-font-faces-to-check '(font-lock-doc-face font-lock-comment-face))
...
#+begin_src emacs-lisp :tangle "anupam-emacs-module/anupam-emacs-version-control.el"
  ...
  (use-package magit
    ...
    :config
    ;; ---------------------------------------------------------------------------
    ;; commit summary should be just '80' characters long
...
#+begin_src emacs-lisp :tangle "anupam-emacs-module/anupam-emacs-langs.el"
  ...
  (use-package eglot
    :ensure nil
    :config
    (add-to-list 'eglot-server-programs `(c-mode   . (,anupam-lsp-server-with-args)))
    (add-to-list 'eglot-server-programs `(c++-mode . (,anupam-lsp-server-with-args)))
