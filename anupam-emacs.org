...
#+begin_src emacs-lisp :tangle "anupam-emacs-module/anupam-emacs-mode-line.el"
  ...
  (defun anupam-modeline--git-info-text (file-name branch-name)
    ...
    (concat
     ...
     " "
     (propertize branch-name 'face 'shadow)
     "]"
     ))
  ...
  ;; ==============================================================================
  ;; date-time-info, only displayed when window is selected.
  ;;
  ;; i use the venerable 'format-time-string' here. syntax reminder:
  ;;     '%a' => abbreviated name of the week, Mon(day), Tue(sday)...
  ...
  (defvar-local anupam-modeline--date-time-info
      '(:eval
        (when (mode-line-window-selected-p)
          (propertize (format-time-string "%a %b %d %H:%M") 'face 'shadow)))
