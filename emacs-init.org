...
#+begin_src emacs-lisp
  ...
  (use-package smooth-scrolling
    ...
    ;; stop scrolling by huge margins
...
** Global keys
 ...
 #+begin_src emacs-lisp
   ...
   (use-package emacs
     ...
     ;; ---------------------------------------------------------------------------
     ;; toggle line-number and invisible character display in buffers
     (global-set-key (kbd "C-c <f6>") #'anupamk:utils/toggle-invisibles)
     (global-set-key (kbd "C-c <f7>") #'anupamk:utils/toggle-line-numbers)
    ...
    #+begin_src emacs-lisp
      ...
      (use-package deadgrep
        ...
        (defun anupamk:deadgrep/get-repo-root-dir ()
          ...
          (concat "/tarana/home/anupam/source-code/tw-repos/"
                  tw-repo-root
                  "/tarana3/cpu/applications/src/"))

        (when (or (anupamk:utils/host-name-is "pnq-dev-01.pnq.taranawireless.com")
                  (anupamk:utils/host-name-is "devel1.india.taranawireless.com"))
...
*** Language Server Configuration
    ...
    #+begin_src emacs-lisp
      ...
      (use-package eglot
        ...
        (defvar anupamk:var/clangd-executable 
          (when (or (anupamk:utils/host-name-is "devel1.india.taranawireless.com")
        ...
        ;; ---------------------------------------------------------------------------
        ;; both c and c++ buffers can be managed via eglot
        (add-to-list 'eglot-server-programs `((c++-mode) ,anupamk:var/clangd-executable))
    ...
    #+begin_src emacs-lisp
      ...
      and when found, run 'compile-cmdstr'"
        ...
        (defun anupamk:cc-utils/compile-eventually-with-bazel(target)
          "compile with bazel"
          (interactive)
          (defvar bazel-compile-cmdstr (concat "set -e ; time t3 build --gen-compile-commands -c " target " | cut -c26-"))
    ...
    #+begin_src emacs-lisp
      ...
      (use-package cc-mode
        ...
        (defun anupamk:cc/common-mode-hook ()
          ...
          ;;
          ;; no need to complicate this whole thing with
          ;; `locate-dominating-file' business etc. etc. , as `clang-format'
          ;; already looks for a `.clang-format' file up the directory tree
          ;; recursively.
        ...
        (add-hook 'c-mode-hook    #'anupamk:cc/c-mode-hook)
        (add-hook 'c++-mode-hook  #'anupamk:cc/c++-mode-hook)
