...
** Use Package
  ...
  way more informaton, see [[https://github.com/jwiegley/use-package#getting-started][this]] or [[https://jwiegley.github.io/use-package/keywords/][this]].
...
(use-package pdf-tools
  ...
  ;; ---------------------------------------------------------------------------
  ;; enabled where we might actually use this package
  :if (or (anupamk:utils/host-name-is "astra")
