...
;; -----------------------------------------------------------------------------
;; enable this in all programming modes, with slightly tweaked settings
...
;; -----------------------------------------------------------------------------
;; explicitly load cmake-mode.el
(load-file (expand-file-name "straight/repos/cmake/Auxiliary/cmake-mode.el" user-emacs-directory))
(require 'cmake-mode)

(anupamk:utils/add-many-to-list 'auto-mode-alist
