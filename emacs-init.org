...
** Project Configuration
   ...
   + Since about version =25= or thereabouts, Emacs introduced the
     native project management via =project.el=. =eglot= (the built-in
     lsp client), by default, uses that for its activities. Let us set
     that up.
     ...
     #+begin_src emacs-lisp
       ...
       for markers defined in ALL-MARKER-LISTS"
         ...
         (defvar project-root-markers (list "Cargo.toml"
                                            "WORKSPACE"
                                            "compile_commands.json"
                                            "compile_flags.txt"
                                            ".git")

         "list of possible project root markers that we care about")
