    ...
    #+begin_src emacs-lisp
      ...
      (use-package emacs
        ...
        (let ((anupamk/buffer-font-height (cond ((anupamk:utils/host-name-is "pnq-dev-01.pnq.taranawireless.com") 110)
                                                ((anupamk:utils/host-name-is "aws-devel-01") 109)
                                                (t 110))))
...
**** EGLOT
     ...
     + Although a bit 'barebones' at times, =eglot= seems to have
       couple of things in its favor. Most notable among them being
       inbuilt into Emacs, and being almost /zero touch/ in setting it
       up.
