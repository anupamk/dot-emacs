    ...
    + On high dpi displays, I have found =Pragmata= to be excellent
      ...
      #+begin_src emacs-lisp
        ...
        (use-package emacs
          ...
          (let ((anupamk/buffer-font-height (cond ((anupamk:utils/host-name-is "pnq-dev-01.pnq.taranawireless.com") 130)
                                                  ((anupamk:utils/host-name-is "devel1.india.taranawireless.com") 130)
                                                  (t 120))))
