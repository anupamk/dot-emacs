    ...
    #+begin_src emacs-lisp
      ...
      (use-package cc-mode
        ...
        (defun anupamk:cc/common-mode-hook ()
          ...
          ;;
          ;; note the `t' as the 4th argument below. if non-nil, says to
          ;; modify the hook's buffer-local value rather than its global
          ;; value, which makes the hook buffer-local...
