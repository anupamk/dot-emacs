...
** Make Emacs Snappier Again
+ Garbage collect on focus-out

  #+begin_src emacs-lisp

    (add-function :after after-focus-change-function
      (defun anupamk:utils/garbage-collect-maybe ()
 ...
 + Moreover the elaborate thing that you see is mostly stolen from
  ...
  #+begin_src emacs-lisp
    ...
    (use-package emacs
      ...
      ;; ---------------------------------------------------------------------------
      ;; affe find files
      (define-key anupamk/global-keymap (kbd "C-c C-l") #'affe-find)
...
#+begin_src emacs-lisp
  ...
  (use-package emacs
    ...
    :functions (anupamk:utils/insert-current-date
    ...
    #+begin_src emacs-lisp
      ...
      (use-package emacs
        ...
        (defun setup-compilation-buffer-font()
          (interactive)
          (setq buffer-face-mode-face '(:family "Pragmata Pro Mono" :height 90))
          (buffer-face-mode))
...
**** Zenburn
 ...
 #+end_src
    ...
    + Syntax highlighting should be, imnsho, kept to a minimum.
       ...
       (use-package emacs
         ...
         (browse-url-handlers
          '(
            ...
            ;; ------------------------------------------------------------------------
            ;; use chromium for everything else
            ("."                        . browse-url-chromium)
            )))
...
** VTerm t.h.e full-fledged terminal within
   ...
   #+begin_src emacs-lisp
     ...
     (use-package vterm
       ...
       (defun anupamk/spawn-vterm-in-project ()
   ...
   + pretty vanilla configuration
     ...
     #+begin_src emacs-lisp
       ...
       (use-package emacs
         ...
         :hook
         (java-mode-hook . anupamk:java-mode-hook))
