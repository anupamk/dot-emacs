    ...
    #+begin_src emacs-lisp
      ...
      (use-package emacs
        ...
        (let ((anupamk/buffer-font-height (cond ((anupamk:utils/host-name-is "pnq-dev-01.pnq.taranawireless.com") 120)
          ...
          (set-face-attribute 'default nil :font "Go Mono" :height anupamk/buffer-font-height))
        ...
        (defun setup-compilation-buffer-font()
          (interactive)
          (setq buffer-face-mode-face '(:family "PragmataPro Mono" :height 90))
          (buffer-face-mode))
    ...
    + IMHO, optimal way of using Emacs is via searching and narrowing
      ...
      #+begin_src emacs-lisp
        ...
        (use-package consult
          ...
          ;; ---------------------------------------------------------------------------
          ;; configure register formatting, which improves registe preview for
          ;; `consult-register', `consult-register-load',
          ;; `consult-register-store' and the emacs builtins.
          (setq register-preview-delay 0
                register-preview-function #'consult-register-format)

          ;; ---------------------------------------------------------------------------
          ;; tweak register preview window. this adds thin lines, sorting and
          ;; hides the mode line of the window
          ...
          ;; ---------------------------------------------------------------------------
          ;; some consult commands support live previews, f.e., when we scroll
          ;; through items of `consult-line', the buffer will scroll to the
          ;; corresponding position.
          ;;
          ;; by default automatic preview is on. a better approach is to
          ;; disable automatic preview where file loading is involved.
          (consult-customize
        ...
        (use-package selectrum
          :ensure t
          :functions (anupamk:utils/minibuffer-kill-backwards)
        ...
        parent directory, otherwise delete a word"
          ...
          (selectrum-num-candidates-displayed 13)
        ...
        ;; -----------------------------------------------------------------------------
        ;; integrate prescient with selectrum
...
** Bookmark places in buffer
   ...
   #+begin_src emacs-lisp
     ...
     (use-package bookmark
       ...
       :bind  (("C-c s b" . anupamk:bookmark/quick-save-bookmark)))
