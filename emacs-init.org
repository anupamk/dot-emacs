    ...
    #+begin_src emacs-lisp
      ...
      (use-package eglot
        ...
        (defvar anupamk:eglot/clangd-executable
          (cond ((or (anupamk:utils/host-name-is "devel1.india.taranawireless.com")
        ...
        :config
        (add-to-list 'eglot-server-programs (list '(c++-mode c-mode) anupamk:eglot/clangd-executable))
